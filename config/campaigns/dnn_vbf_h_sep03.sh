...
# DNN output in the VBF Higgs sidebands, regenerated after the FullEventId
# inference fix. CAMPAIGN_OPTIONS preserves the existing bundled all/ layout;
# --systematics-layout split selects separate family jobs.
CAMPAIGN_ROOT="/eos/user/v/vdamante/H_mumu/Sep_03/DNN_VBF_H_AllWeights"
CAMPAIGN_LABEL="Sep03_DNN_VBF_H_AllWeights"
HIST_DIR_PREFIX=""
